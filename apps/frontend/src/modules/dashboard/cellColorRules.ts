...
//   "light" — Call/Put/Future/Spot Open/High/Low/Close (subtle backgrounds)
//   "dark"  — Call/Put/Future/Spot MMA/TLA + the Indicators section
//             (stronger backgrounds, white text)
// "black" (drop >= 15%) is intentionally identical in both themes — a large
// drop reads the same regardless of column group.
...
const TRACKED_COLUMNS: Record<string, TrackedColumnDef> = {
  // Group A — Call/Put/Future/Spot OHLC (light theme)
  "ce-o": { accessor: (r) => r.call.o, theme: "light", truncateForColor: true },
  "ce-h": { accessor: (r) => r.call.h, theme: "light", truncateForColor: true },
  "ce-l": { accessor: (r) => r.call.l, theme: "light", truncateForColor: true },
  "ce-c": { accessor: (r) => r.call.c, theme: "light", truncateForColor: true },
  "pe-o": { accessor: (r) => r.put.o, theme: "light", truncateForColor: true },
  "pe-h": { accessor: (r) => r.put.h, theme: "light", truncateForColor: true },
  "pe-l": { accessor: (r) => r.put.l, theme: "light", truncateForColor: true },
  "pe-c": { accessor: (r) => r.put.c, theme: "light", truncateForColor: true },
  "fut-o": { accessor: (r) => r.future.o, theme: "light", truncateForColor: true },
  "fut-h": { accessor: (r) => r.future.h, theme: "light", truncateForColor: true },
  "fut-l": { accessor: (r) => r.future.l, theme: "light", truncateForColor: true },
  "fut-c": { accessor: (r) => r.future.c, theme: "light", truncateForColor: true },
  "spot-o": { accessor: (r) => r.spot.o, theme: "light", truncateForColor: true },
  "spot-h": { accessor: (r) => r.spot.h, theme: "light", truncateForColor: true },
  "spot-l": { accessor: (r) => r.spot.l, theme: "light", truncateForColor: true },
  "spot-c": { accessor: (r) => r.spot.c, theme: "light", truncateForColor: true },
